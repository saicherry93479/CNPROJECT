...
set bandwidth [ open pojectSampleDSDVTHB.xg w]

set throughput [ open pojectSampleDSDVTHT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSDVTH.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSDVTH.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSDVTH.nam &
 exec xgraph pojectSampleDSDVTHB.xg &
 exec xgraph pojectSampleDSDVTHT.xg & 
 exit 0
}
