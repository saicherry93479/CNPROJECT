...
set bandwidth [ open pojectSampleAODVOFB.xg w]

set throughput [ open pojectSampleAODVOFT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleAODVOF.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleAODVOF.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleAODVOF.nam &
 exec xgraph pojectSampleAODVOFB.xg &
 exec xgraph pojectSampleAODVOFT.xg & 
 exit 0
}
