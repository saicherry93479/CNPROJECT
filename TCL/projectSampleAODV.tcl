...
set bandwidth [ open pojectSampleAODVB.xg w]

set throughput [ open pojectSampleAODVT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleAODV.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleAODV.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleAODV.nam &
 exec xgraph pojectSampleAODVB.xg &
 exec xgraph pojectSampleAODVT.xg & 
 exit 0
}
