...
set bandwidth [ open pojectSampleDSDVB.xg w]

set throughput [ open pojectSampleDSDVT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSDV.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSDV.nam w]
...
for {set x 18} {$x>1} {incr x -1 } {
	...
	$ns at $time1 "$n_($i) setdest [expr (1000-$x_($i))%1000] [expr (1000-$y_($i))%1000] 50.0"
...
proc finish {} {
 ...
 exec nam projectSampleDSDV.nam &
 exec xgraph pojectSampleDSDVB.xg &
 exec xgraph pojectSampleDSDVT.xg & 
 exit 0
}
