...
set bandwidth [ open pojectSampleDSRBS.xg w]

set throughput [ open pojectSampleDSRTS.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSRS.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSRS.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSRS.nam &
 exec xgraph pojectSampleDSRBS.xg &
 exec xgraph pojectSampleDSRTS.xg & 
 exit 0
}
