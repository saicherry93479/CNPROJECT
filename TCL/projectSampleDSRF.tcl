...
set bandwidth [ open pojectSampleDSRBF.xg w]

set throughput [ open pojectSampleDSRTF.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSRF.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSRF.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSRF.nam &
 exec xgraph pojectSampleDSRBF.xg &
 exec xgraph pojectSampleDSRTF.xg & 
 exit 0
}
