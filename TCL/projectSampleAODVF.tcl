...
set bandwidth [ open pojectSampleAODVBF.xg w]

set throughput [ open pojectSampleAODVTF.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleAODVF.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleAODVF.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleAODVF.nam &
 exec xgraph pojectSampleAODVBF.xg &
 exec xgraph pojectSampleAODVTF.xg & 
 exit 0
}
