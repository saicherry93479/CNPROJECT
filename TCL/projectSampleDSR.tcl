...
set bandwidth [ open pojectSampleDSRB.xg w ]

set throughput [ open pojectSampleDSRT.xg w ]

#creation of Trace and namfile 
set tracefile [open projectSampleDSR.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSR.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSR.nam &

 exec xgraph pojectSampleDSRB.xg &
 exec xgraph pojectSampleDSRT.xg & 
 exit 0
}
