...
set bandwidth [ open pojectSampleDSROFB.xg w]

set throughput [ open pojectSampleDSROFT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSROF.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSROF.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSROF.nam &
 exec xgraph pojectSampleDSROFB.xg &
 exec xgraph pojectSampleDSROFT.xg & 
 exit 0
}
