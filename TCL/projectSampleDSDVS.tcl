...
set bandwidth [ open pojectSampleDSDVBS.xg w]

set throughput [ open pojectSampleDSDVTS.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSDVS.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSDVS.nam w]
...
$ns at 1.0 "$n_(0) setdest 10.0 999.0 20.0"
$ns at 1.0 "$n_(69) setdest 100.0 900.0 20.0"


$ns at 30.0 "$n_(0) setdest 400.0 500.0 20.0"
$ns at 30.0 "$n_(69) setdest 10.0 600.0 20.0"

$ns at 39.0 "$n_(0) setdest 500.0 609.0 20.0"
$ns at 39.0 "$n_(69) setdest 100.0 100.0 20.0"

$ns at 1.0 "$n_(1) setdest 10.0 999.0 20.0"
$ns at 20.0 "$n_(1) setdest 300.0 100.0 20.0"
...
proc finish {} {
 ...
 exec nam projectSampleDSDVS.nam &
 exec xgraph pojectSampleDSDVBS.xg &
 exec xgraph pojectSampleDSDVTS.xg & 
 exit 0
}
