...
set bandwidth [ open pojectSampleDSRTHB.xg w]

set throughput [ open pojectSampleDSRTHT.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleDSRTH.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleDSRTH.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleDSRTH.nam &
 exec xgraph pojectSampleDSRTHB.xg &
 exec xgraph pojectSampleDSRTHT.xg & 
 exit 0
}
