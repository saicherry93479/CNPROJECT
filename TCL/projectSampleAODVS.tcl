...
set bandwidth [ open pojectSampleAODVBS.xg w]

set throughput [ open pojectSampleAODVTS.xg w]

#creation of Trace and namfile 
set tracefile [open projectSampleAODVS.tr w]
$ns trace-all $tracefile

#Creation of Network Animation file
set namfile [open projectSampleAODVS.nam w]
...
proc finish {} {
 ...
 exec nam projectSampleAODVS.nam &
 exec xgraph pojectSampleAODVBS.xg &
 exec xgraph pojectSampleAODVTS.xg & 
 exit 0
}
